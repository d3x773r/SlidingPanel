package com.gurpster.library.blur;
...
public class GlassView extends RelativeLayout {
    ...
    private void initAttributes(AttributeSet attrs) {
        TypedArray typedArray = getContext().obtainStyledAttributes(attrs, com.ms.square.android.glassview.R.styleable.GlassView);
        mDownSampling = typedArray.getInt(com.ms.square.android.glassview.R.styleable.GlassView_downSampling, DEFAULT_DOWN_SAMPLING);
        setBlurRadius(typedArray.getFloat(com.ms.square.android.glassview.R.styleable.GlassView_blurRadius, DEFAULT_BLUR_RADIUS));
        typedArray.recycle();
    }
